...
var bilibili_translation = [-400, 0, -400];
...
var bilibili2_translation = [40, 0, -400];
...
function drawSceneIndex() {
  ...
  mvMatrix =  m4.multiply(m4.multiply( m4.multiply( m4.multiply( m4.multiply(m4.multiply(changeMatrix,T),Rx),Ry),Rz),S),unchangeMatrix);
	matrix = m4.multiply(perMatrix,mvMatrix);
  ...
  var zNear = 1;
  var zFar = 2000;
  var perMatrix = m4.perspective(bilibili2_fieldOfViewRadians, aspect, zNear, zFar);
