...
webglLessonsUI.setupSlider("#light_posx", { value: light_pos[0], slide: light_updatePosition(0), min: -1000, max: 200 });
webglLessonsUI.setupSlider("#light_posy", { value: light_pos[1], slide: light_updatePosition(1), min: -1000, max: 800 });
webglLessonsUI.setupSlider("#light_posz", { value: light_pos[2], slide: light_updatePosition(2), min: -1000, max: 200 });
// 设置UI
