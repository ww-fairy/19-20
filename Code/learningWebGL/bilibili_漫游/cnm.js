...
function animateBilibili(){
  ...
  var angleInDegrees = 10;
  var angleInRadians = angleInDegrees * Math.PI / 180;
  bilibili_rotation[1] += angleInRadians % 360;

  if(forward){
  bilibili2_translation[0] += 10 * bilibili2_directZ[0];
  bilibili2_translation[1] += 10 * bilibili2_directZ[1];
  bilibili2_translation[2] += 10 * bilibili2_directZ[2];
...
function drawground()
{
  ...
  ground_vertices = [
    ...
    -800,  -100,  500,     800,  -100,  500,  // v1 Magenta
    800, -100,  -500,     800,  -20,  -500,  // v2 Red
    -800, -20,  -500,     -800,  -100,  -500,  // v3 Yellow
  ]
